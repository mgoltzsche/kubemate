...
replace github.com/k3s-io/k3s => github.com/k3s-io/k3s v1.33.4-0.20250716193733-236cbf257332

// Copied from https://github.com/k3s-io/k3s/blob/v1.33.3%2Bk3s1/go.mod#L5
replace (
