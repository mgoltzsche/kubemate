...
replace (
	github.com/k3s-io/k3s => github.com/k3s-io/k3s v1.33.5-0.20250814212538-148243c49519
	github.com/rancher/k3s => github.com/k3s-io/k3s v1.33.5-0.20250814212538-148243c49519
)

// Copied from https://github.com/k3s-io/k3s/blob/v1.33.4%2Bk3s1/go.mod#L5
replace (
...
require (
	...
	github.com/k3s-io/helm-controller v0.16.13 // indirect
	github.com/k3s-io/kine v0.13.17 // indirect
