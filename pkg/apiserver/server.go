...
func NewServer(o ServerOptions) (*genericapiserver.GenericAPIServer, error) {
	...
	serverConfig.EffectiveVersion = basecompatibility.NewEffectiveVersionFromString(version.Version, version.Version, version.Version)
	...
	installDeviceControllers(genericServer, logger,
		...
		&devicectrl.DeviceReconciler{
			...
			NetworkInterfaceNames: o.AdvertiseIfaces,
